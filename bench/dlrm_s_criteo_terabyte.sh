...
$dlrm_pt_bin --arch-sparse-feature-size=64 --arch-mlp-bot="13-512-256-64" --arch-mlp-top="512-512-256-1" --max-ind-range=10000000 --data-generation=dataset --data-set=terabyte --raw-data-file=./terabyte_input/day --processed-data-file=./terabyte_input/terabyte_processed.npz --loss-function=bce --round-targets=True --learning-rate=0.1 --mini-batch-size=8192 --print-freq=1024 --print-time --test-mini-batch-size=16384 --test-num-workers=16 --qr-flag --qr-threshold 0 --qr-collision 8 --memory-map --num-batches 2048 --enable-profiling $dlrm_extra_option 2>&1 | tee run_terabyte_pt.log
