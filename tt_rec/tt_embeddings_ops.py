...
class TTLookupFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        *tt_cores: Tuple[torch.Tensor],
        ...
        # jhlim
        # print("nnz_tt:", nnz_tt)
        # print("nnz_cached:", nnz_cached)
        # print("Processed indices:", indices)
        # print("Row indices:", rowidx)
        # print("Table indices:", tableidx)
...
class TableBatchedTTEmbeddingBag(torch.nn.Module):
    ...
    def forward(
        ...
        # print("num_embeddings:", self.num_embeddings)   # the number of embeddings of each table
        # print("indices:", indices)                      # accessed embedding index
        # print("num_tt_indices:", num_tt_indices)      # the number of indices (= size of mini-batch)
